...
export default function SkeletonUser() {
    ...
    return (
        <>
            <section className="flex h-[220px] w-[200px] items-center justify-around rounded-m border-slate-300 md:content-center">
                <div className="flex h-full w-full animate-pulse flex-col items-center justify-center space-y-m p-m">
                    ...
                    <div className={clsx(skeletonText, 'h-[8px]')}></div>
                    <div className={clsx(skeletonText, 'h-[8px]')}></div>
                    <div className={clsx(skeletonText, 'h-[30px]')}></div>
                </div>
            </section>
